...
The Investigator Agent is an AI-powered system that analyzes software releases to identify potential risks. It uses Claude (Anthropic) to assess release information, call tools to gather data, and generate risk reports with severity levels.
...
The Investigator Agent assesses software release risk by:
